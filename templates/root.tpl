...
[ root_ca ]
certificate             = {{CA_ROOT_DIR}}/ca/ca.crt             # The CA cert
private_key             = {{CA_ROOT_DIR}}/ca/private/ca.key     # CA private key
serial                  = {{CA_ROOT_DIR}}/ca/db/crt.srl         # Serial number file
crlnumber               = {{CA_ROOT_DIR}}/ca/db/crl.srl         # CRL number file
database                = {{CA_ROOT_DIR}}/ca/db/certificate.db  # Index file
